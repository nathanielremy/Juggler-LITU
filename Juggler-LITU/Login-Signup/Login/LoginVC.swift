...
class LoginVC: UIViewController {
    ...
    let switchToSignupButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "Apply to become a ", attributes: [.font : UIFont.systemFont(ofSize: 14), .foregroundColor : UIColor.lightGray])
        attributedTitle.append(NSAttributedString(string: "Juggler.", attributes: [.font : UIFont.boldSystemFont(ofSize: 14), .foregroundColor : UIColor.mainBlue()]))
